...
% Para obter um mapeamento da câmera colorida para o scanner da cabeça, o alvo foi escaneado usando o laser e a câmera de alcance. Uma vez que o scanner retornou a intensidade refletida pelo laser, bem como a profundidade, pode-se calcular as coordenadas 3D de cada ponto da \emph{feature}.
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\linewidth]{figs/ferramentasMich.jpg}
	\caption{%
