...
O principal componente de hardware do sistema é um escaneador de triangulação a laser, que é composto por 4 eixos motorizados, um laser, uma câmera de alcance, uma câmera de cores e uma luz branca~\ref{fig:cabecaScanner}, isso tudo acrescido de suportes e estruturas para o escaneamento de estátuas grandes. O objetivo de um escaneador deste porte era capturar marcas menores que um milímetro, das ferramentas utilizadas por Michelangelo em suas esculturas. 
