\chapter{Reconstrução 3D Ativa}\label{cap:laser}
...
regiões sem textura.  Neste capítulo, abordamos o projeto clássico de escaneamento da
...
por Michelangelo em suas esculturas.  Para isso, foram testadas diversas
