...
\begin{figure}[!h]
	...
	\caption{%
	Funcionamento do MVE. Começando com múltiplas imagens, técnicas SfM são empregadas para recontruir os parâmetros das câmeras e os conjuntos de pontos esparsos. Mapas de profundidade são computados para cada imagem usando o MVS. Finalmente, uma malha colorida é extraída da união de todos os mapas de profundidade usando um algoritmo de aproximações de reconstruções de superfícies (FSSR).%\cite{Cui:Theobalt:etal:PAMI2013,Pajdla:etal:ICCV2011}.
...
\begin{figure}[!h]
	\centering
	%   \includegraphics[width=1.0\linewidth]{figs/3d-curve-sketch/system-diagram.eps}
	\includegraphics[width=1\linewidth]{figs/umve1.png}
	\caption{%
...
\begin{figure}[!h]
	\centering
	%   \includegraphics[width=1.0\linewidth]{figs/3d-curve-sketch/system-diagram.eps}
	\includegraphics[width=1\linewidth]{figs/umve5sfm.png}
	\caption{%
...
Entretanto, para a aplicação proposta neste projeto, não é muito interessante, visto que ele utiliza a informação das câmeras ({\it EXIF}) e das imagens e, como as imagens empregadas na reconstrução são, tecnicamente, vídeos cortados em determinados {\it frames}, não é possível obter a informação das câmeras \ref{fig:mveexif}, logo o {\it software} não tem tanta aplicabilidade neste caso, pois recai no problema dos parâmetros padrões adotados para as câmeras não serem bons o suficiente para estes conjuntos de dados, a menos que sejam tiradas fotos sequenciais de alguma escultura ou objeto que se deseja gerar a reconstrução densa, pois dessa forma, as informações necessárias das câmeras estarão armazenadas.

\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/exifumve.png}(a)
	\includegraphics[width=1\linewidth]{figs/exifsemumve.png}(b)
	\caption{%
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/umvedense.png}
	\caption{%
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/umve2sfm.png} (a)
	\includegraphics[width=1\linewidth]{figs/umve3sfmfeature.png} (b)
	\includegraphics[width=1\linewidth]{figs/umve4ba.png} (c)
	\caption{%
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/sfmmve.png}
	\caption{%
...
O próximo comando, {\it dmrecon} demorou cerca de 4 horas, usando como configuração um nível L2, com 20 vizinhos \ref{fig:MVEDenseRecon}. Usando um nível L0, o algoritmo rodou durante 6 horas aproximadamente e foi cancelado devido à demora na execução. 

\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/umvetempo.png}
	\caption{%
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/mvemesh.png}
	\caption{%
...
Para juntar todos os níveis do {\it scene2pet}, foi usado o {\it fssrecon}, que gera uma única reconstrução. Este processo demorou bastante, cerca de 7 horas \ref{fig:MVEFSSR}. Que teve como resultado a malha \ref{fig:MVEFSSRMesh}.

\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{figs/mvemeshtempo2.png}
	\caption{%
