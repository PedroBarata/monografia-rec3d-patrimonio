...
\noindent \textbf{1 - Adicionar imagens.} Este é o primeiro passo, para
  começar uma reconstrução: primeiro adiciona-se imagens ao software. Pode ser
...
\noindent\textbf{4 - Reconstrução densa.} Finalmente, acaba a reconstrução rodando o algoritmo de reconstrução densa~\cite{gavadense} CMVS/PMVS-2 embutido no próprio VisualSfM.
