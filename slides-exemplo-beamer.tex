...
\frametitle{\textbf{SIFT -- \emph{Scale Invariant Feature Transform}}}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=0.5\linewidth]{figs/indioSIFT.jpg}
			\caption{%
				Exemplo de correspondências SIFT.
			}
		\end{figure}
...
\frametitle{\textbf{Objeto com 200 imagens usando o VisualSfM}}
	\begin{center}
		\movie[width=160px, height=90px, externalviewer]{Assistir a animação da reconstrução}{gifs/galinhaVisualSfm200.webm}
	\end{center}
\end{frame}
...
\frametitle{\textbf{Objeto com 224 imagens usando o VisualSfM}}
		\begin{center}
		\movie[width=160px, height=90px, externalviewer]{Assistir a animação da reconstrução}{gifs/galinhaVisualSFM224.webm}
	\end{center}
\end{frame}
% ---------------------------------------------------------------------------- 
\subsubsection{MVE}
...
\begin{frame}
\frametitle{\textbf{Objeto com 200 imagens usando o MVE}}
	\movie[width=160px, height=90px, externalviewer]{Assistir a animação da reconstrução}{gifs/galinha200MVE.webm}
\end{frame}
...
\frametitle{\textbf{Escultura com VisualSfM}}
	\begin{center}
		\movie[width=160px, height=90px, externalviewer]{Assistir a animação da reconstrução}{gifs/indioVisualSFM.webm}
	\end{center}
\end{frame}
...
\frametitle{\textbf{Escultura com MVE}}
		\begin{center}
		\movie[width=160px, height=90px, externalviewer]{Assistir a animação da reconstrução}{gifs/sapoMVE.webm}
	\end{center}
\end{frame}
