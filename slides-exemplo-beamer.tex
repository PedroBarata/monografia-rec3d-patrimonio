...
\begin{frame}
	\begin{center}
	\textbf{Structure from motion -- SfM} é uma técnica fotogramétrica baseada em estimar a posição de estruturas tridimendisionais  a partir de sequencias de imagens em duas dimensões. 
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
		\includegraphics[width=0.20\linewidth]{figs/lena.jpg}
		\includegraphics[width=0.20\linewidth]{figs/lenaSigma1.png}
		\includegraphics[width=0.20\linewidth]{figs/lenaSigma2.png}
	 	\includegraphics[width=0.20\linewidth]{figs/lenaDoG.png}
	\end{center}
\end{frame}
