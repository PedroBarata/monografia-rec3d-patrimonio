...
%It turns out that the ratio of the two eigenvalues, say {\displaystyle \alpha } \alpha  is the larger one, and {\displaystyle \beta } \beta  the smaller one, with ratio {\displaystyle r=\alpha /\beta } r=\alpha /\beta 
