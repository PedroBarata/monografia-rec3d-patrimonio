...
\begin{figure}[!h]
	...
	\caption{%
	Procedimento da maioria dos sistemas SfM. Além dessas
  etapas, geralmente a reconstrução é densificada usando-se MVS\protect\cite{theia-manual}.
...
imagem~\ref{}) em cada imagem~\cite{Lowe:IJCV2004}.

\begin{figure}[!h]
	\centering
	\includegraphics[width=\linewidth]{figs/indioSIFT.jpg}
	\includegraphics[width=\linewidth]{figs/SIFTsapo.jpg}
	\includegraphics[width=\linewidth]{figs/SIFTsapo2.jpg}
	\caption{%
	Imagens de correspondências do SIFT, onde cada linha interpreta uma correspondência encontrada entre as duas imagens.
	}\label{fig:sfmpipeline}
\end{figure}
