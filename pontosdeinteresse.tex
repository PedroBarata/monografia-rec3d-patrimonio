\chapter{Técnicas de fotogrametria passiva}\label{cap:pontosdeinteresse}
%======================================================================================
%
\section*{Introdução}
...
da reconstrução para um dos sistemas se diferem, e a partir de agora, faremos
abordagens individuais para cada um deles.
