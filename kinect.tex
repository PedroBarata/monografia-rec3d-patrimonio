...
\begin{figure}[!h]
	...
	\subfloat[Imagem do lado esquerdo da câmera
  SLR]{\label{fig:SLResq}\includegraphics[height=0.2\linewidth]{figs/imagemSLResquerda.png}}
	\subfloat[Imagem da profundidade do
  Kinect]{\label{fig:KinectDepth}\includegraphics[height=0.2\linewidth]{figs/imagemProfundidadeKinect.png}}
	\subfloat[Imagem do lado direito da câmera
  SLR]{\label{fig:SLRdir}\includegraphics[height=0.2\linewidth]{figs/imagemSLRdireita.png}}
  	\source{
   	 \citeauthor{smisek20133d},
   	 \citeyear{smisek20133d}.
   }
...
\begin{figure}[!h]
	...
	\legend{%
	(a) é a reconstrução do SLR e (b) o resultado do Kinect. Qualitativamente ambas são satisfatórias.
	\source{
   	 \citeauthor{smisek20133d},
   	 \citeyear{smisek20133d}.
   }
